...
public class Personal_veranstaltungen extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Personal_veranstaltungen frame = new Personal_veranstaltungen();
	 ...
	 * Create the frame.
	 */
	public Personal_veranstaltungen() {
		...
		scrollPane.setBounds(23, 45, 730, 378);
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"nummer", "name", "start", "dauer", "gebaeude"
			}
		));
		...
		btnNewButton.setBounds(308, 441, 156, 50);
		...
		btnNewButton_1.setBounds(23, 10, 96, 21);
